...
public class Test0 {
	...
	public static void main(String[] args) {
		...
		System.out.println(t);
		t.insert("peter");
		SplayBST temp = new SplayBST(t);
		SplayBSTXtra temp1 = new SplayBSTXtra();
		temp1.root = temp.root;
		temp1.insert("apple");
		...
		System.out.println(t);
		System.out.println("Stick count: " + t.stickCt());
		System.out.println("Height count: " + t.height());
		System.out.println();
		System.out.println();
